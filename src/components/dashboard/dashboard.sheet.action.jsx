...
export default function SheetAction({ icon, text, color, onClick }) {
  return (
    <div className="flex flex-row gap-4 items-center py-3 px-2 rounded-lg hover:bg-neutral-100/20 hover:text-yellow-500 transition duration-500 cursor-pointer" onClick={onClick}>
