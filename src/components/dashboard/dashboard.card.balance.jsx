...
export default function CardBalance({ balance, income, total, name }) {
        ...
        <div className="flex justify-between gap-1 flex-row p-3 item-center">
          <div className="flex flex-col justify-between flex-1 p-2">
            <div>
              ...
              <div className="mt-1 flex items-center gap-4">
                <h2 className="text-xl font-semibold tracking-tight text-white sm:text-4xl lg:text-5xl">Rp {balance}</h2>

                <button className="flex h-5 w-5 items-center justify-center rounded-full text-white/70 transition hover:bg-white/10 hover:text-white">
              ...
              <p className="my-2 sm:my-4 text-[9px] text-white/60">
                Today income Rp.{income} / {total} claim
              </p>
            </div>
          ...
          <div className="">
            <div className="relative w-[160px] h-[110px] sm:h-[165px] sm:w-[280px] lg:h-[175px] lg:w-[300px]">
              ...
              <div className="relative h-full w-full overflow-hidden rounded-2xl border border-red-200/15 bg-gradient-to-br from-[#7b292b] via-[#54191c] to-[#160708] p-3 shadow-2xl">
                <div className="pointer-events-none absolute -left-20 -top-20 h-40 w-[150%] rotate-[-20deg] bg-gradient-to-r from-transparent via-white/[0.08] to-transparent blur-md" />
                <div className="pointer-events-none absolute -right-16 -top-16 h-40 w-40 rounded-full bg-red-400/10 blur-3xl" />
                <div className="pointer-events-none absolute -right-14 -top-14 h-36 w-36 rounded-full border border-white/[0.08]" />
